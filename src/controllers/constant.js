                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" class="luckysheet-paneswrapper">
                                                ...
                                                <div class="luckysheet-cell-main " id="luckysheet-cell-main">
                                                    ...
                                                    <div id="luckysheet-button-showBoxs">
                                                        <div id="luckysheet-modal-dialog-activeButton" class="luckysheet-modal-dialog" style="display:none;padding:0;position:absolute;z-index:300;">
                                                        ...
                                                        <div class="cell-date-picker">
                                                            <input id="cellDatePickerBtn2" class="formulaInputFocus" readonly="readonly"/>
                                                        </div>
                                                    </div>
