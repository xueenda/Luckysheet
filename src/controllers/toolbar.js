...
export const toolbarIdMap = {
    ...
    button: '#luckysheet-insertBtn-btn-title', //'Insert Button'
...
export function createToolbarHtml() {
    ...
    const htmlMap = {
        file: `<div class="luckysheet-toolbar-select luckysheet-toolbar-menu-button luckysheet-inline-block" data-tips="${toolbar.file}"
        id="luckysheet-icon-file" role="button" style="user-select: none;">
        ...
        id="luckysheet-icon-currency" role="button" style="user-select: none;">
            ...
            style="user-select: none;">
                <div class="luckysheet-toolbar-button-inner-box luckysheet-inline-block"
                style="user-select: none;">
                    <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none; font-size: 15px">
                    $
                    </div>
                </div>
            </div>
        ...
        button: `<div class="luckysheet-toolbar-button-split-left luckysheet-toolbar-button luckysheet-inline-block"
        data-tips="${toolbar.insertButton}" id="luckysheet-insertBtn-btn-title" role="button" style="user-select: none;">
            <div class="luckysheet-toolbar-button-outer-box luckysheet-inline-block"
            style="user-select: none;">
                <div class="luckysheet-toolbar-menu-button-inner-box luckysheet-inline-block"
                style="user-select: none;">
                    ...
                    style="user-select: none;">
                        <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                            <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-none iconfont luckysheet-iconfont-shujuku"
                            style="user-select: none;">
                            </div>
                        </div>
                    </div>
